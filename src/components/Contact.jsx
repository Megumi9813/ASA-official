...
function Contact() {
  ...
  return (
    <div id="contact">
        <div className={contactOpen ? "contact_background open" : "contact_background"}></div>
        <div className={contactOpen ? "contact_container open" : "contact_container"}>
            <div className="contact-wrapper">
                ...
                <div className="contact_half-form">
                    ...
                    <div className="form__item">
                        ...
                        <textarea className="input" name="inquiry" type="text"></textarea>
                    </div>
        ...
        <Link to="#">
            <button className='mail_btn' onClick={() => setContactOpen(!contactOpen)}>
